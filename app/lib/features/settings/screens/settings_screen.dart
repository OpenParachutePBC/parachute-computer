...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Widget _buildMigrationSection(bool isDark) {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              OutlinedButton.icon(
                onPressed: () => _scanMigration(isDark),
                icon: const Icon(Icons.search, size: 18),
                label: const Text('Scan for Issues'),
              ),
              SizedBox(width: Spacing.md),
              FilledButton.icon(
                onPressed: () => _runMigration(isDark),
  ...
  Future<void> _scanMigration(bool isDark) async {
  ...
  Future<void> _runMigration(bool isDark) async {
    final chatService = ref.read(chatServiceProvider);
