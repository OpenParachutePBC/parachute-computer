...
- [ ] User can dismiss a pending question without submitting an answer
- [ ] Dismissing sends `answerQuestion({})` to unblock the server Future
- [ ] Server timeout path still works as fallback if dismiss is not used
