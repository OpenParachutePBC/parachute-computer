...
- [ ] "Other" text field has a visible or enforced character limit (500 recommended)
- [ ] Attempting to submit an oversized answer shows an error message, does not send
- [ ] Normal answers (≤500 chars) still submit correctly
