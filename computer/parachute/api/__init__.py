...
from parachute.api import (
    agents, auth, bots, brain, capabilities, chat, claude_code, container_files, credentials,
    projects, context_folders, filesystem, health, hooks, imports, mcp, models, modules,
    plugins, prompts, sandbox, scheduler, sessions, settings, skills, sync, usage,
)
...
api_router.include_router(container_files.router, tags=["project-files"])
