...
### 7. **Optional: Specialized Agent Invocation** (Post-Documentation)
   ...
   - **architecture_issue** → `parachute-conventions-reviewer`
   - Python code-heavy issue → `python-reviewer` + `code-simplicity-reviewer`
   - Flutter code-heavy issue → `flutter-reviewer` + `code-simplicity-reviewer`
...
Specialized Agent Reviews (Auto-Triggered):
  ...
  ✓ python-reviewer: Code examples meet Python standards
...
### Code Quality & Review
- **python-reviewer**: Reviews Python code examples for FastAPI/Pydantic/async best practices
- **flutter-reviewer**: Reviews Flutter/Dart code examples for Riverpod and widget patterns
...
- **parachute-conventions-reviewer**: Verifies module boundaries, trust levels, MCP patterns

### Enhancement & Documentation
- **best-practices-researcher**: Enriches solution with industry best practices
- **framework-docs-researcher**: Links to Python/Flutter/framework documentation references
