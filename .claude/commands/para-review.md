...
6. Task code-simplicity-reviewer(PR content)
7. Task agent-native-reviewer(PR content) - Verify new features are agent-accessible

**If PR touches `computer/` (Python code):**
8. Task python-reviewer(PR content) - FastAPI, Pydantic, async patterns, type hints

**If PR touches `app/` (Flutter code):**
9. Task flutter-reviewer(PR content) - Riverpod, widget composition, Dart conventions

**If PR crosses module boundaries or touches MCP/trust/security:**
...
- python-reviewer (if computer/ touched)
- flutter-reviewer (if app/ touched)
- parachute-conventions-reviewer (if cross-module)
- security-sentinel
- performance-oracle
