...
description: "Check that code is as simple as possible. Identifies over-engineering, unnecessary abstractions, and YAGNI violations."
model: sonnet
---
...
5. **Apply YAGNI Rigorously**:
   ...
   - Never flag `docs/plans/*.md` or `docs/solutions/*.md` for removal — these are engineering pipeline artifacts created by `/plan` and used as living documents by `/work`
