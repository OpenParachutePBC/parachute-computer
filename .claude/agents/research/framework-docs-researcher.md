...
description: "Gather documentation and best practices for specific frameworks, libraries, or dependencies. Use when API signatures, version constraints, or implementation patterns need verification."
model: sonnet
---
