...
Note that files in `docs/plans/` and `docs/solutions/` are engineering pipeline artifacts created by `/para:plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
