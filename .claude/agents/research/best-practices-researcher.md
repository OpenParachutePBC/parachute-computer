...
description: "Research external best practices, documentation, and examples for any technology or framework. Use when the codebase lacks examples and external patterns are needed."
model: sonnet
---
...
2. **Identify Relevant Skills**:
   ...
   - Python/FastAPI → `python-reviewer` agent
   - Flutter/Dart → `flutter-reviewer` agent
   - AI/Agents/MCP → `agent-native-architecture`, `create-agent-skills`
   - Architecture → `parachute-conventions-reviewer` agent
...
2. **Organize Discoveries**:
   ...
   - Clearly indicate source: "From agent: python-reviewer" vs "From official docs" vs "Community consensus"
...
- **Agent/skill-based**: "The python-reviewer agent recommends..." (highest authority - curated)
